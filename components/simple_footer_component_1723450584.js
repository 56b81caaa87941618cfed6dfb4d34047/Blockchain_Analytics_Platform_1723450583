...
*/
Vue.component("simple_footer_component_1723450584", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            ChainScan: Blockchain Intelligence Suite
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with ChainScan's cutting-edge blockchain analytics and monitoring tools. Gain real-time insights, identify trends, and make data-driven decisions for your decentralized applications and investments.
                    </div>
                </div>
            </div>
        </footer> 
